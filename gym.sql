...
('GYM1', 'GYM NAME1', 'Kurubarahalli', 'men'),
('GYM2', 'GYM NAME2', 'ShankarMutt', 'unisex'),
('GYM3', 'GYM NAME3', 'Malleswaram', 'unisex'),
('GYM4', 'GYM NAME4', 'Rajajinagar', 'women'),
('GYM5', 'GYM NAME5', 'Yeshavantapuram', 'men'),
('GYM6', 'GYM NAME6', 'JP Nagar', 'unisex'),
('GYM7', 'GYM NAME7', 'Milk Colony', 'women'),
('GYM8', 'GYM NAME8', 'Meakri Circle', 'men');
...
('M1', 'Chethan', '18/08/1994', '26', '5200', '8888888888', 'Payment1', 'T1'),
('M2', 'Jeevan', '26/06/1998', '21', '4800', '9988998899', 'Payment2', 'T2'),
('M3', 'Chirag', '22/07/1997', '22', '6400', '9977997799', 'Payment3', 'T3'),
('M4', 'Yuvraj', '21/08/1998', '21', '5400', '9966996699', 'Payment4', 'T4'),
('M5', 'Balaji', '24/06/1999', '20', '6000', '9955995599', 'Payment5', 'T5');
...
('T1', 'Darshan', '5:00 AM', '9999999999', 'Payment1'),
('T2', 'Punieth', '9:00 AM', '8888888888', 'Payment2'),
('T3', 'Yash', '11:00 AM', '7777777777', 'Payment3'),
('T4', 'Sudeep', '1:00 PM', '6666666666', 'Payment6'),
('T5', 'Kratos', '3:00 PM', '6655665566', 'Payment5'),
('T6', 'Cloud', '5:00 PM', '6677667766', 'Payment6'),
('T7', 'PewDiePie', '7:00 PM', '6688668866', 'Payment7'),
('T8', 'Allu Arjun', '9:00 PM', '6699669966', 'Payment8');
