...
<body style="background:url(gym_bg1.jpg); background-size: cover;">
    ...
    <div class="list-group">
      ...
      <div id="collapseThree" class="collapse" data-parent="#accordion">
        <div class="list-group-item" style="background-color: #303030;">
          <a href="home.php?info=add_payment" class="text-light">ADD PAYMENT</a>
        </div>
        <div class="list-group-item" style="background-color: #303030;">
          <a href="home.php?info=manage_payment" class="text-light">VIEW PAYMENTS</a>
        </div>
      </div>
         <div class="list-group-item bg-dark">
